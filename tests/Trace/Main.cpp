...
// and using p7_shared objects for P7 client & trace                             //
////////////////////////////////////////////////////////////////////////////////
...
//                                   TEST 7                                   //
////////////////////////////////////////////////////////////////////////////////
// Here we check p7_shared memory                                                //
////////////////////////////////////////////////////////////////////////////////

#define SHARED_TRACE      TM("P7.Trace.p7_shared")
...
int Test_07(int i_iArgC, char* i_pArgV[])
{
    ...
    for (int l_iI = 0; l_iI < i_iArgC; l_iI++)
    {
        if (0 == STRNICMP(i_pArgV[l_iI], TEST_HELP, LENGTH(TEST_HELP)-1))
        {
            printf("This test ckeck wokring of p7_shared memory and next functions:\n"
                   " - IP7_Trace::Share(...)\n"
                   " - P7_Get_Shared_Trace\n"
                   " - IP7_Telemetry::Share(...)\n"
